...
export async function initHero() {
  ...
  const fadeCanvas = () => { const f = Math.min(1, window.scrollY / ((window.innerHeight || 1) * 0.85)); canvas.style.opacity = (1 - f * 0.56).toFixed(3); };  // ease off, but keep the cake present (min ~0.44)
